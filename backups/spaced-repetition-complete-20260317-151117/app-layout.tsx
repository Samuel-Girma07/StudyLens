      ...
      {showSidebar && (
        <aside className="sticky top-0 h-screen w-72 border-r border-white/10 bg-background-dark/80 backdrop-blur-xl flex flex-col p-6 z-50">
          ...
          <div className="mt-auto pt-6 border-t border-white/5">
            {/* Settings */}
            <Link href="/profile" className="flex items-center gap-4 px-4 py-3 text-slate-400 hover:text-white transition-colors">
            ...
            {/* Pro Member Card */}
            <div className="mt-4 p-4 glass-panel border border-white/10">
