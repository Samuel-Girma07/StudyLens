    ...
    <AppLayout>
      <div className="min-h-screen p-8">
        ...
        <div className="card-brutalist p-6">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 bg-purple-500 flex items-center justify-center shadow-brutalist-lime">
              <span className="material-symbols-outlined text-white">auto_awesome</span>
            </div>
            <div>
              <h3 className="text-white font-bold">AI Learning Tools</h3>
              <p className="text-mono text-[10px] uppercase tracking-widest text-slate-500">Your AI-powered study sessions</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <div className="glass-panel p-4 text-center">
              <div className="w-10 h-10 mx-auto bg-accent-cyan/10 border border-accent-cyan/30 flex items-center justify-center mb-3">
                <span className="material-symbols-outlined text-accent-cyan">summarize</span>
              </div>
              <p className="text-2xl font-bold text-white">{data?.aiStats?.summaries || 0}</p>
              <p className="text-mono text-[9px] uppercase tracking-widest text-slate-500 mt-1">Summaries</p>
            </div>

            {/* Flashcards */}
            <div className="glass-panel p-4 text-center">
              <div className="w-10 h-10 mx-auto bg-accent-lime/10 border border-accent-lime/30 flex items-center justify-center mb-3">
                <span className="material-symbols-outlined text-accent-lime">style</span>
              </div>
              <p className="text-2xl font-bold text-white">{data?.aiStats?.flashcards || 0}</p>
              <p className="text-mono text-[9px] uppercase tracking-widest text-slate-500 mt-1">Flashcard Sets</p>
            </div>
            ...
            <div className="glass-panel p-4 text-center">
              ...
              <p className="text-2xl font-bold text-white">{data?.aiStats?.quizzes || 0}</p>
              <p className="text-mono text-[9px] uppercase tracking-widest text-slate-500 mt-1">Quizzes</p>
            </div>

            {/* Notes */}
            <div className="glass-panel p-4 text-center">
              <div className="w-10 h-10 mx-auto bg-teal-500/10 border border-teal-500/30 flex items-center justify-center mb-3">
                <span className="material-symbols-outlined text-teal-400">note_stack</span>
              </div>
              <p className="text-2xl font-bold text-white">{data?.aiStats?.notes || 0}</p>
              <p className="text-mono text-[9px] uppercase tracking-widest text-slate-500 mt-1">Notes</p>
            </div>
            ...
            <div className="glass-panel p-4 text-center">
              ...
              <p className="text-2xl font-bold text-white">{data?.aiStats?.explanations || 0}</p>
              <p className="text-mono text-[9px] uppercase tracking-widest text-slate-500 mt-1">Explanations</p>
            </div>

            {/* Chat Sessions */}
            <div className="glass-panel p-4 text-center">
              <div className="w-10 h-10 mx-auto bg-rose-500/10 border border-rose-500/30 flex items-center justify-center mb-3">
                <span className="material-symbols-outlined text-rose-400">chat</span>
              </div>
              <p className="text-2xl font-bold text-white">{data?.chatSessions || 0}</p>
              <p className="text-mono text-[9px] uppercase tracking-widest text-slate-500 mt-1">AI Chats</p>
            </div>
          </div>

          {(data?.aiStats?.total || 0) === 0 && (data?.chatSessions || 0) === 0 && (
            <div className="mt-6 p-6 border border-white/5 text-center">
              <span className="material-symbols-outlined text-4xl text-slate-600 block mb-3">auto_awesome</span>
              <p className="font-mono text-xs text-slate-500 uppercase tracking-widest">
                Start using AI tools to generate summaries, flashcards, quizzes, and more!
              </p>
              <Link href="/" className="inline-block mt-4">
                <button className="bg-accent-cyan text-black px-6 py-3 font-mono text-xs font-bold uppercase tracking-widest shadow-[3px_3px_0px_#CCFF00] hover:bg-white transition-colors">
                  Explore Resources
                </button>
              </Link>
            </div>
              ...
              {data.recentResources.map((resource) => (
                <Link key={resource.id} href={`/resource/${resource.id}`}>
                  <div className="glass-panel p-4 group hover:border-accent-cyan/50 transition-all duration-300 hover:-translate-y-1">
                    {/* Thumbnail */}
                    <div className="aspect-video bg-white/5 border border-white/10 mb-3 overflow-hidden flex items-center justify-center">
                      {resource.thumbnail ? (
                        <img 
